...
export default function AdicionarImovel() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Erro ao adicionar imóvel";
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Adicionar URLs bem-sucedidas ao formulário
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Preencha os dados do imóvel para adicioná-lo ao sistema
              </p>
            </div>

            {success && (
              <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                Imóvel adicionado com sucesso! Redirecionando...
              </div>
            )}
